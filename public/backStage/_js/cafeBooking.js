...
function postData() {
    ...
    $.ajax({
        ...
        method: 'Post',
        data: {
            "bookingExist": bookingExistCreate,
...
function putData() {
    // console.log('put');
    let cafeBookingIDEdit = $('.editUIID').val()
    ...
    $.ajax({
        ...
        method: 'put',
        data: JSON.stringify({
            "cafeBookingID": cafeBookingIDEdit,
            "bookingExist": bookingExistEdit,
...
function patchData(exist){
    // console.log('patch');
    let cafeBookingID = exist==1? $('.onUIID').val(): $('.removeUIID').val();
    // console.log(cafeBookingID);
...
function deleteData(){
    // console.log('delete');
    let cafeBookingID = $('.deleteUIID').val();
    // console.log(cafeBookingID);
...
async function edit(elem) {
    ...
    let dataStr = await  getData(`?cafeBookingID=${id}`)
    let dataJson = JSON.parse( dataStr)
    let data = dataJson[0]
    // console.log(data);
    $('.editUIID').val(data.cafeBookingID)
    $('#bookingExistEdit').val(data.bookingExist)
